...
- (void)inicioDelView
{
    ...
    {
        MStatus = [NSString stringWithFormat:@"¡Actualización de UCObus disponible! Actualiza la aplicación para poder recibir actualizaciones de horarios"];
    }else if (status==3)
    {
...
-(IBAction)recargarHorario:(id)sender {
    ...
    {
        MStatus = [NSString stringWithFormat:@"¡Actualización de UCObus disponible! Actualiza la aplicación para poder realizar actualizaciones de horarios"];
    }else if (status==3)
    {
        MStatus = [NSString stringWithFormat:@"¡Error de consulta! Nuestros tecnicos lo resolveran lo antes posible"];
    }else if (status==4)
...
- (NSInteger)actualizaHorario
{
    ...
    //                                                                                                                          //
    NSString *pApp          = [NSString stringWithFormat:@"UCObus"];                        // Nombre de la aplicación      //
    NSString *pVersion      = [NSString stringWithFormat:@"1.6"];                           // Versión de la aplicación     //
    NSString *pBuild        = [NSString stringWithFormat:@"10617"];                         // Build de la aplicación       //
    NSString *pPlataform    = [NSString stringWithFormat:@"ios"];                           // Plataforma de la aplicación  //
    NSString *pTipoH        = [NSString stringWithFormat:@"bus"];                           // Tipo de horario a pedir      //
